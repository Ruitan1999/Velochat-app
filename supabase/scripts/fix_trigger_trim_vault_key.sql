...
-- Updates the trigger to use a custom push_trigger_secret (not the service_role key).
-- This avoids the legacy vs new key format mismatch that causes 401.
-- After running this, also run setup_push_trigger_secret.sql.
